...
Modify the application port for a specific overseas server accelerator.

## Request URL

`https://api.zhaomu.com/accelerator/port/:id`
...
|--------|--------|--------|--------|--------|
| port |  | Yes | int | New application port. Ports 80/443 are not supported |
...
{
  "success": true,
  "message": "Accelerator application port modified successfully"
}
```
